  ...
  return (
    <section id="education" className="py-24 px-6 lg:px-12">
      <div className="max-w-4xl mx-auto">
        <p className="text-primary font-semibold text-sm tracking-widest uppercase mb-3 text-center">{t.background}</p>
        <h2 className="text-3xl lg:text-4xl font-bold tracking-tight mb-4 text-center">{t.education}</h2>
